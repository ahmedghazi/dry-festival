...
import { $t as isRecord, Ct as useClickOutsideEvent, Dn as _getArrayProp, Ht as Stack, Kt as Box, Qt as createGlobalScopedContext, Ut as Text, Vt as Flex, Zt as _cardColorStyle, _n as isHTMLAnchorElement, an as useRootTheme, cn as require_react_is, dn as ft, en as responsiveRadiusStyle, fn as gt, it as useGlobalKeyDown, jn as getTheme_v2, tn as useLayer, tt as Hotkeys, vn as isHTMLButtonElement } from "./dist-MhpRzy4S.js";
import { o as Popover } from "./LoadingBlock-Cy2Pckab-CaBiwwPj.js";
import { t as ChevronRightIcon } from "./ChevronRight-DdTArvZr.js";
//#region node_modules/.pnpm/@sanity+ui@4.0.3_react-dom@19.2.8_react@19.2.8__react@19.2.8_styled-components@6.5.3_re_84e50c1ed67c9b277dbd65efc234bba4/node_modules/@sanity/ui/dist/menu.js
...
*/
function Menu(props) {
	let $ = (0, import_compiler_runtime.c)(50), children, forwardedRef, onClickOutside, onEscape, onItemClick, onItemSelect, onKeyDown, originElement, registerElement, restProps, t0, t1, t2;
	...
	$[14] === Symbol.for("react.memo_cache_sentinel") ? (t3 = () => ref.current, $[14] = t3) : t3 = $[14], (0, import_react.useImperativeHandle)(forwardedRef, t3);
	...
	}, t7 = [activeIndex, onItemSelect], $[21] = activeIndex, $[22] = onItemSelect, $[23] = t6, $[24] = t7) : (t6 = $[23], t7 = $[24]), (0, import_react.useEffect)(t6, t7);
	let t8;
	...
	let value = t10, t11;
	$[38] !== children || $[39] !== gap ? (t11 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stack, {
		gap,
		children
	}), $[38] = children, $[39] = gap, $[40] = t11) : t11 = $[40];
	let t12;
	$[41] !== handleKeyDown || $[42] !== handleRefChange || $[43] !== padding || $[44] !== restProps || $[45] !== t11 ? (t12 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledMenu, {
		"data-ui": "Menu",
		...restProps,
	...
	let t13;
	return $[47] !== t12 || $[48] !== value ? (t13 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuContext.Provider, {
		value,
		children: t12
...
var MenuGroup = function MenuGroup(props) {
	...
	$[48] !== IconComponent || $[49] !== fontSize ? (t26 = IconComponent && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, {
		size: fontSize,
	...
	let t27;
	$[51] !== fontSize || $[52] !== text ? (t27 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		flex: 1,
	...
	let t29;
	$[55] === fontSize ? t29 = $[56] : (t29 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
		size: fontSize,
		children: t28
	}), $[55] = fontSize, $[56] = t29);
	let t30;
	$[57] !== gap || $[58] !== padding || $[59] !== t26 || $[60] !== t27 || $[61] !== t29 ? (t30 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
		gap,
		padding,
		children: [
			t26,
...
var MenuItem = function MenuItem(props) {
	...
	$[48] !== IconComponent || $[49] !== IconRightComponent || $[50] !== fontSize || $[51] !== gap || $[52] !== hotkeys || $[53] !== hotkeysFontSize || $[54] !== paddingProps || $[55] !== text ? (t20 = (IconComponent || text || IconRightComponent) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
		as: "span",
		gap,
		align: "center",
		...paddingProps,
...
//#endregion
export { MenuItem as a, MenuGroup as i, MenuButton as n, MenuDivider as r, Menu as t };
