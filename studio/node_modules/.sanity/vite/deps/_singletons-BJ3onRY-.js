...
//#region node_modules/.pnpm/sanity@6.9.2_@babel+core@7.29.7_@babel+runtime@7.29.7_@noble+hashes@2.3.0_@rolldown+plu_bc69515520d3729ef0d8dbe997d16e6c/node_modules/sanity/lib/version-DTqx_kFw.js
var buildVersion;
try {
...
* @beta
*/
var SANITY_VERSION = buildVersion || "6.9.2";
//#endregion
//#region node_modules/.pnpm/sanity@6.9.2_@babel+core@7.29.7_@babel+runtime@7.29.7_@noble+hashes@2.3.0_@rolldown+plu_bc69515520d3729ef0d8dbe997d16e6c/node_modules/sanity/lib/_createContext.js
...
//#endregion
//#region node_modules/.pnpm/sanity@6.9.2_@babel+core@7.29.7_@babel+runtime@7.29.7_@noble+hashes@2.3.0_@rolldown+plu_bc69515520d3729ef0d8dbe997d16e6c/node_modules/sanity/lib/_singletons.js
...
var EditDialogOuterBoundaryContext = createGlobalScopedContext("sanity/_singletons/context/edit-dialog-outer-boundary", null);
...
var PresentationContext = createGlobalScopedContext("sanity/_singletons/context/presentation", null);
var PresentationDisplayedDocumentContext = createGlobalScopedContext("sanity/_singletons/context/presentation/displayed-document", null);
var PresentationDocumentContext = createGlobalScopedContext("sanity/_singletons/context/presentation/document", null);
var PresentationNavigateContext = createGlobalScopedContext("sanity/_singletons/context/presentation/navigate", null);
var PresentationPanelsContext = createGlobalScopedContext("sanity/_singletons/context/presentation/panels", null);
var PresentationParamsContext = createGlobalScopedContext("sanity/_singletons/context/presentation/params", null);
var PresentationSharedStateContext = createGlobalScopedContext("sanity/_singletons/context/presentation/shared-state", null);
...
var ZIndexContext = createGlobalScopedContext("sanity/_singletons/context/z-index", zIndexContextDefaults);
//#endregion
export { PackageVersionInfoContext as $, VisibleWorkspacesContext as $t, DocumentLimitUpsellContext as A, SchedulePublishUpsellContext as At, FormFieldPresenceContext as B, SourceContext as Bt, DiffContext as C, ReleasesUpsellContext as Ct, DocumentDivergencesContext as D, ReviewChangesContext as Dt, DocumentChangeContext as E, ResourceCacheContext as Et, EventsContext as F, SelectedAnnotationsContext as Ft, HoveredFieldContext as G, TasksContext as Gt, FreeTrialContext as H, StudioAnnouncementContext as Ht, FeedbackContext as I, SingleDocReleaseContext as It, LocaleContext as J, TasksUpsellContext as Jt, IsLastPaneContext as K, TasksEnabledContext as Kt, FieldActionsContext as L, SingleDocReleaseEnabledContext as Lt, DocumentPaneInfoContext as M, SchedulesContext as Mt, EditDialogOuterBoundaryContext as N, ScrollContext as Nt, DocumentFieldActionsContext as O, RouterContext as Ot, EnhancedObjectDialogContext as P, SearchContext as Pt, NavbarContext as Q, VirtualizerScrollInstanceContext as Qt, FormBuilderContext as R, SingleDocReleaseUpsellContext as Rt, DialogStackContext as S, ReleasesMetadataContext as St, DocumentActionsStateContext as T, ResolvedPanesProvider as Tt, FullscreenPTEContext as U, StudioErrorHandlerContext as Ut, FormValueContext as V, StructureToolContext as Vt, GetFormValueContext as W, TableContext as Wt, MediaLibraryIdsContext as X, UserColorManagerContext as Xt, LoggedOutReasonContext as Y, UserApplicationCacheContext as Yt, MentionUserContext as Z, ValidationContext as Zt, CommentsOnboardingContext as _, PresentationParamsContext as _t, ArrayValidationContext as a, PortableTextMarkersContext as at, ConfigErrorContext as b, ReferenceInputOptionsContext as bt, ChangeIndicatorTrackerContextGetSnapshot as c, PortableTextMemberSchemaTypesContext as ct, ColorSchemeValueContext as d, PresenceTrackerContextStore as dt, WorkspaceContext as en, PaneContext as et, CommentInputContext as f, PresentationContext as ft, CommentsIntentContext as g, PresentationPanelsContext as gt, CommentsEnabledContext as h, PresentationNavigateContext as ht, ArrayItemRootElementContext as i, SANITY_VERSION as in, PerspectiveContext as it, DocumentPaneContext as j, ScheduledPublishingEnabledContext as jt, DocumentIdContext as k, RouterHistoryContext as kt, ChangeIndicatorTrackerContextStore as l, PresenceContext as lt, CommentsContext as m, PresentationDocumentContext as mt, AddonDatasetContext as n, ZIndexContext as nn, PaneRouterContext as nt, AssetLimitUpsellContext as o, PortableTextMemberItemElementRefsContext as ot, CommentsAuthoringPathContext as p, PresentationDisplayedDocumentContext as pt, LiveUserApplicationContext as q, TasksNavigationContext as qt, AppIdCacheContext as r, zIndexContextDefaults as rn, ParseErrorsContext as rt, CalendarContext as s, PortableTextMemberItemsContext as st, ActiveWorkspaceMatcherContext as t, WorkspacesContext as tn, PaneLayoutContext as tt, ColorSchemeSetValueContext as u, PresenceTrackerContextGetSnapshot as ut, CommentsSelectedPathContext as v, PresentationSharedStateContext as vt, DocumentActionPropsContext as w, ResolvedPanesContext as wt, CopyPasteContext as x, ReferenceItemRefContext as xt, CommentsUpsellContext as y, PreviewCardContext as yt, FormCallbacksContext as z, SortableItemIdContext as zt };
