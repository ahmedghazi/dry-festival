...
//#region node_modules/.pnpm/sanity@6.9.2_@babel+core@7.29.7_@babel+runtime@7.29.7_@noble+hashes@2.3.0_@rolldown+plu_bc69515520d3729ef0d8dbe997d16e6c/node_modules/sanity/lib/QRCodeSVG-eJx0bZij.js
...
function useQRCode(t0) {
	let $ = (0, import_compiler_runtime.c)(24), { value, level, minVersion, includeMargin, marginSize, logoSize, size } = t0, t1;
...
function QRCodeSVGComponent(props) {
	let $ = (0, import_compiler_runtime.c)(26), { value, size: t0, level: t1, color: t2, minVersion: t3, title, logoSize } = props, size = t0 === void 0 ? 128 : t0, level = t1 === void 0 ? "L" : t1, color = t2 === void 0 ? "#000000" : t2, minVersion = t3 === void 0 ? 1 : t3, t4;
	...
	$[13] === title ? t8 = $[14] : (t8 = !!title && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("title", { children: title }), $[13] = title, $[14] = t8);
	let t10, t11, t9;
