 ...
 * @public
 */
export declare interface BufferedResponse {
  /** HTTP status code. */
  status: number;
  /** HTTP status text. */
  statusText: string;
...
export declare type DefaultResponse<
  As extends "json" | "text" | "stream" | undefined = undefined,
> = As extends "json"
  ? JsonResponse
  : As extends "text"
    ? TextResponse
 ...
 * @public
 */
export declare interface JsonResponse<T = unknown> {
  /** HTTP status code. */
  status: number;
  /** HTTP status text. */
  statusText: string;
 ...
 * @public
 */
export declare interface RequesterOptions {
 ...
 * @public
 */
export declare interface RequestFunction<
 ...
 * @public
 */
export declare interface TextResponse {
  /** HTTP status code. */
  status: number;
  /** HTTP status text. */
  statusText: string;
 ...
 * @public
 */
export declare interface TransformMiddleware {
 ...
 * @public
 */
export declare type WrappingMiddleware = (
  options: RequestOptions,
