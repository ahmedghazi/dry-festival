import { n as TypedObject, t as DeserializerRule } from "./types-DlDb6U1D.js";
 ...
 * @public
 */
declare function htmlToPortableText(html: string, options?: HtmlToPortableTextOptions): (Omit<TypedObject | import("@portabletext/schema").PortableTextTextBlock<TypedObject | import("@portabletext/schema").PortableTextSpan>, "_key"> & {
  _key: string;
})[];
/**
 ...
 * @public
 */
declare const defaultSchema: import("@portabletext/schema").Schema;
